...
const Footer = () => {
  return (
    ...
    <footer className='flex justify-start items-center flex-col lg:px-20 py-6 px-5 w-full gap-20 bg-[#1F1F22]'>
       
    <div className='flex flex-col gap-12 w-full '> 
    <div className='flex items-start flex-col'>
        <h1 className='font-bold text-[#a8a2fa] text-[30px]'>Blogeey</h1>
      <p className='text-start text-sm font-normal mt-5 max-w-xs text-gray-100'> Blogeey
